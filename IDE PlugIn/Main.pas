...
//TODO
 ...
 {DONE -oRRUZ -cIssue :Fix menu background color}
...
procedure Register;
begin
   AddLog2('Register', 'Init');
   IDEWizard:=TIDEWizard.Create;
   AddLog2('RegisterPackageWizard');
   RegisterPackageWizard(IDEWizard as IOTAWizard);
   AddLog2('Register', 'Done');
end;
{$ENDIF}
...
begin
  try
    ...
    begin
        AddLog2('TIDEWizard.InitColorizer', 'Init');
        LINTAServices := (BorlandIDEServices as INTAServices);
        if LINTAServices <> nil then
        begin
          AddLog2('TIDEWizard.InitColorizer', 'RegisterColorizerAddinOptions');
          ...
          begin
            ...
            if found then
            begin
              AddLog2('TIDEWizard.InitColorizer', 'SetColorizerVCLStyle');
              ...
              AddLog2('TIDEWizard.InitColorizer', 'LoadSettings');
          ...
          begin
            AddLog2('TIDEWizard.InitColorizer', 'RefreshIDETheme');
            RefreshIDETheme();
          end;
        end;
        AddLog2('TIDEWizard.InitColorizer', 'Done');
    end;
  except
    on E: exception do
    begin
...
begin
  inherited;
  try
    AddLog2('TIDEWizard.Create', 'Init');
 ...
 {$ENDIF}
    ...
    AddLog2('TIDEWizard.Create', 'Done');
  except
    on E: exception do
    begin
