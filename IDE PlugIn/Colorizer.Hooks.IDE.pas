...
begin
  ...
  begin
   ...
   if ShouldDrawClose then
     ...
     if TColorizerLocalSettings.Settings.UseVCLStyles and  TColorizerLocalSettings.Settings.VCLStylesForms then
     begin
      ...
      ColorizerStyleServices.GetElementColor(LDetails, ecTextColor, LColor);
