type
  TIDEInsightForm=class(TPopupSearchForm)
  private
   FEditSearchControl  :TWinControl;
   FMaxCatWidth        :Integer;
   FMinWidth           :Integer;
   FMaxWidth           :Integer;
   FWidthIsAdjusted    :Boolean;
   FDrawingHint        :Boolean;
   FMonitor            :TMonitor;
   FVMargin            :Integer;
   FHMargin            :Integer;
   FHintVMargin        :Integer;
   FHintHMargin        :Integer;
   FManager            :TBaseIDEInsightManager;
  ...
  public
   constructor Create(AOwner: TComponent; AManager: TBaseIDEInsightManager; AEditSearchControl: TWinControl);
   constructor Create(AOwner: TComponent; AManager: TBaseIDEInsightManager);
   function Execute: Boolean;
   function Execute(var Items: INTAIDEInsightItemArray): Boolean;
   procedure Refresh;
   ...
   class destructor Destroy;
   property EditSearchControl: TWinControl;
   property Manager: TBaseIDEInsightManager;
  ...
  published
   MainPanel           :TPanel;
   FilterEdit          :TFilterEdit;
   DrawTree            :TVirtualDrawTree;
   ...
   procedure DrawTreeKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
   procedure FormClose(Sender: TObject; var Action: TCloseAction);
   procedure FilterEditKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
   procedure DrawTreeClick(Sender: TObject);
   procedure FormCreate(Sender: TObject);
   procedure DrawTreeDrawNode(Sender: TBaseVirtualTree; const PaintInfo: TVTPaintInfo);
   procedure DrawTreeMeasureItem(Sender: TBaseVirtualTree; TargetCanvas: TCanvas; Node: PVirtualNode; var NodeHeight: Integer);
   procedure DrawTreeGetNodeWidth(Sender: TBaseVirtualTree; HintCanvas: TCanvas; Node: PVirtualNode; Column: TColumnIndex; var NodeWidth: Integer);
   procedure FilterEditClearFilter(Sender: TObject);
   procedure FilterEditPerformFilter(Sender: TObject; const Text: string);
   procedure ApplicationEvents1ShowHint(var HintStr: string; var CanShow: Boolean; var HintInfo: THintInfo);
   procedure DrawTreeDrawHint(Sender: TBaseVirtualTree; HintCanvas: TCanvas; Node: PVirtualNode; R: TRect; Column: TColumnIndex);
   procedure DrawTreeGetHintSize(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex; var R: TRect);
   ...
   procedure FilterEditKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
   procedure DrawTreeKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
   procedure DrawTreeDblClick(Sender: TObject);
   procedure DrawTreeGetHintSize(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex; var R: TRect);
   procedure DrawTreeDrawHint(Sender: TBaseVirtualTree; HintCanvas: TCanvas; Node: PVirtualNode; R: TRect; Column: TColumnIndex);
   procedure ApplicationEvents1ShowHint(var HintStr: string; var CanShow: Boolean; var HintInfo: THintInfo);
   procedure DrawTreeGetNodeWidth(Sender: TBaseVirtualTree; HintCanvas: TCanvas; Node: PVirtualNode; Column: TColumnIndex; var NodeWidth: Integer);
   procedure FilterEditClearFilter(Sender: TObject);
   procedure DrawTreeIncrementalSearch(Sender: TBaseVirtualTree; Node: PVirtualNode; const SearchText: WideString; var Result: Integer);
   procedure DrawTreeCompareNodes(Sender: TBaseVirtualTree; Node1: PVirtualNode; Node2: PVirtualNode; Column: TColumnIndex; var Result: Integer);
   procedure FilterEditKeyPress(Sender: TObject; var Key: Char);
   procedure DrawTreeZombieOnGetText(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType; var CellText: WideString);
   procedure FormClose(Sender: TObject; var Action: TCloseAction);
   procedure FormCloseQuery(Sender: TObject; var CanClose: Boolean);
