type
  TFlagsView=class(TLabeledList)
  private
   FOldFlags           :TFlags;
   FCurrentFlags       :TFlags;
   FShowOldFlags       :Boolean;
   FFlagType           :TFlagType;
  ...
  public
   ...
   procedure UpdateFlags(NewFlags: TFlags);
   constructor Create(AOwner: TComponent);
   constructor Create(AOwner: TComponent);
   class destructor Destroy;
  ...
  published
   ...
   property Constraints: TSizeConstraints;
   property CurrentFlags: TFlags;
   property DefaultRowHeight: Integer;
   property Enabled: Boolean;
   property FlagType: TFlagType;
   property Font: TFont;
   property OldFlags: TFlags;
   property ParentColor: Boolean;
   property ParentCtl3D: Boolean;
   property ParentFont: Boolean;
   property PopupMenu: TPopupMenu;
   property SelectedFlag: Integer;
   property ShowOldFlags: Boolean;
   property TabOrder: TTabOrder;
   property TabStop: Boolean;
   property Visible: Boolean;
