type
  TFindReferencesForm=class(TBaseRefactoringForm)
  private
  ...
  published
   ...
   actnlstFindReferences:TActionList;
   actnFindReferences  :TAction;
   actnFindLocalReferences:TAction;
   actnViewFindReferences:TAction;
   mnuViewFindReferences:TMenuItem;
   imglstToolbar       :TImageList;
   actnDelete          :TAction;
   acntRemoveAll       :TAction;
   mnuPopDelete        :TMenuItem;
   mnuPopRemoveAll     :TMenuItem;
   ...
   procedure actnViewFindReferencesExecute(Sender: TObject);
   procedure actnDeleteUpdate(Sender: TObject);
   procedure actnDeleteExecute(Sender: TObject);
   procedure acntRemoveAllUpdate(Sender: TObject);
   procedure acntRemoveAllExecute(Sender: TObject);
