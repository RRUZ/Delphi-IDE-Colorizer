type
  TPasModExpFrame=class(TBaseModExpFrame)
  private
   Search              :TTreeControlSearch;
   Disabled            :Boolean;
   FOnNodeFocused      :TNodeFocusedEvent;
  ...
  public
   ...
   procedure FocusNode(const Location: IGraphLocation);
   procedure NewModel(const Name: string; const Model: IGraphModel);
   procedure Disable;
   procedure Enable;
   procedure FocusNode(const Location: IGraphLocation);
   procedure NewModel(const Name: string; const Model: IGraphModel);
   ...
   class destructor Destroy;
   property FocusedLocation: IGraphLocation;
   property Model: IGraphModel;
   property OnNodeFocused: TNodeFocusedEvent;
  ...
  published
   ...
   ViewEditorCmd       :TAction;
   N2                  :TMenuItem;
   ViewEditorMenuItem  :TMenuItem;
   DockableItem        :TMenuItem;
   N3                  :TMenuItem;
   StayOnTopItem       :TMenuItem;
   ExplorerItemImages  :TImageList;
   procedure ExplorerActionPerformed(E: IActionEvent);
   procedure ExplorerSubfocusChanged(E: IGraphSubfocusEvent);
   procedure ExplorerKeyPressed(E: IKeyEvent);
   procedure ExplorerExit(Sender: TObject);
