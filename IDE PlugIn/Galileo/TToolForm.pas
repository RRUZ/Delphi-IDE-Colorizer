type
  TToolForm=class(TDockableForm)
  private
   FPaletteLocked      :Boolean;
   FPaletteLoader      :TPaletteLoader;
   FUpdateCount        :Integer;
   FLastFocusedItem    :string;
   FLastSelectedItem   :string;
   FSavedScrollPos     :TDictionary<System.string,System.Integer>;
   FLastPaletteState   :string;
   FCurrentLayout      :IMappedComponentGroup;
   FCategoryColors     :TColorSaver;
   FLoading            :Boolean;
   FMouseOverButton    :TButtonItem;
   FMouseOverCategory  :TButtonCategory;
   FCategoriesPopup    :TCategoriesPopup;
   FCurrentFilter      :string;
   FSettingFilter      :Boolean;
   FRestoreNotShowingCaptions:Boolean;
   FToolBarInstance    :Pointer;
   FPaletteInstance    :Pointer;
   FToolBarProc        :Pointer;
   FPaletteProc        :Pointer;
   FFirstPopup         :Boolean;
   FLastClickTime      :Cardinal;
   FLastClickedButton  :TObject;
   FCollapsedCats      :TStringList;
   FMRUHistory         :TStringList;
   FNotifyIndex        :Integer;
   FComponentsGroup    :IOTAPaletteGroup;
   FPalServices        :IOTAPaletteServices;
   FToolLocked         :Boolean;
   FEndingUpdate       :Boolean;
   FInHelpRequest      :Boolean;
   FCollapsingAll      :Boolean;
   FLayoutMappingDirty :Boolean;
   FPersistentFilter   :Boolean;
   FInControlOfThePaletteSelection:Boolean;
   FIDEInsightActionListIndex:Integer;
   FMostlyStaticPalette:Boolean;
  ...
  public
   ...
   procedure Destroyed;
   procedure EndUpdate;
   procedure ItemAdded(const Group: IOTAPaletteGroup; const Item: IOTABasePaletteItem);
   procedure ItemRemoved(const Group: IOTAPaletteGroup; const Item: IOTABasePaletteItem);
   procedure Modified;
   procedure SelectedToolChanged(const Tool: IOTABasePaletteItem);
   procedure LoadInitialOptions;
   class procedure BeginOleDrag(Palette: TIDECategoryButtons; InterfaceData: IInterface; DragControl: TWinControl);
   ...
   class destructor Destroy;
   property CategoryColors: TColorSaver;
   property PersistentFilter: Boolean;
   property InControlOfThePaletteSelection: Boolean;
  ...
  published
   popPalette          :TPopupActionBar;
   CollapseAll1        :TMenuItem;
   UncollapseAll1      :TMenuItem;
   actnlstPalette      :TActionList;
   actnToolsBtn        :TAction;
   actnSelector        :TAction;
   actnNewCategory     :TAction;
   NewCategory1        :TMenuItem;
   actnHideButton      :TAction;
   actnResetPalette    :TAction;
   N4                  :TMenuItem;
   ResetPalette1       :TMenuItem;
   HideButton1         :TMenuItem;
   actnRemoveCategory  :TAction;
   mnuOptions          :TMenuItem;
   actnRemoveCategory1 :TMenuItem;
   N5                  :TMenuItem;
   mnuShowButton       :TMenuItem;
   actnLockUnlock      :TAction;
   actnLockUnlock1     :TMenuItem;
   actnDeleteButton    :TAction;
   DeleteButton1       :TMenuItem;
   ViewToolPaletteCommand:TAction;
   ViewToolPaletteItem :TMenuItem;
   actnAutoCollapse    :TAction;
   AutoCollapse1       :TMenuItem;
   actnCollapseAll     :TAction;
   actnUnCollapseAll   :TAction;
   mnuSeperatorBottom  :TMenuItem;
   StayonTop1          :TMenuItem;
   Dockable1           :TMenuItem;
   N3                  :TMenuItem;
   mnuSeperatorTop     :TMenuItem;
   ...
   PopupTools1         :TPopupActionBar;
   ZoomWindowItem      :TMenuItem;
   LocalMenuItem       :TMenuItem;
   ToolButton1         :TToolButton;
   EditPanel           :TPanel;
   FilterEdit          :TButtonedEdit;
   actnRenameCategory  :TAction;
   mnuRenameCategory   :TMenuItem;
   Palette             :TIDECategoryButtons;
   ...
   procedure PopupTools1Popup(Sender: TObject);
   procedure FormCreate(Sender: TObject);
   procedure popPalettePopup(Sender: TObject);
   procedure FormKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
   procedure FormKeyPress(Sender: TObject; var Key: Char);
   procedure FormShow(Sender: TObject);
   procedure FormDestroy(Sender: TObject);
   procedure actnToolsBtnExecute(Sender: TObject);
   procedure actnSelectorExecute(Sender: TObject);
   procedure PaletteButtonClicked(Sender: TObject; const Button: TButtonItem);
   procedure PaletteAfterDrawButton(Sender: TObject; const Button: TButtonItem; Canvas: TCanvas; Rect: TRect; State: TButtonDrawState);
   procedure actnNewCategoryExecute(Sender: TObject);
   procedure PaletteReorderButton(Sender: TObject; const Button: TButtonItem; const SourceCategory: TButtonCategory; const TargetCategory: TButtonCategory);
   procedure PaletteReorderCategory(Sender: TObject; const SourceCategory: TButtonCategory; const TargetCategory: TButtonCategory);
   procedure actnHideButtonExecute(Sender: TObject);
   procedure actnResetPaletteExecute(Sender: TObject);
   procedure actnRemoveCategoryExecute(Sender: TObject);
   procedure actnLockUnlockUpdate(Sender: TObject);
   procedure actnLockUnlockExecute(Sender: TObject);
   procedure PaletteDrawIcon(Sender: TObject; const Button: TButtonItem; Canvas: TCanvas; Rect: TRect; State: TButtonDrawState; var TextOffset: Integer);
   procedure PaletteSelectedItemChange(Sender: TObject; const Button: TButtonItem);
   procedure PaletteCategoryCollapse(Sender: TObject; const Category: TButtonCategory);
   procedure actnDeleteButtonExecute(Sender: TObject);
   procedure PaletteButtonCopied(Sender: TObject; const SourceButton: TButtonItem; const CopiedButton: TButtonItem);
   procedure ViewToolPaletteCommandExecute(Sender: TObject);
   procedure actnAutoCollapseExecute(Sender: TObject);
   procedure actnAutoCollapseUpdate(Sender: TObject);
   procedure actnCollapseAllExecute(Sender: TObject);
   procedure actnUnCollapseAllUpdate(Sender: TObject);
   function FormHelp(Command: Word; Data: NativeInt; var CallHelp: Boolean): Boolean;
   procedure PaletteDrawText(Sender: TObject; const Button: TButtonItem; Canvas: TCanvas; Rect: TRect; State: TButtonDrawState);
   procedure PaletteKeyPress(Sender: TObject; var Key: Char);
   procedure actnToolsBtnUpdate(Sender: TObject);
   procedure PaletteBeginDrag(Sender: TObject; var Handled: Boolean);
   ...
   procedure PaletteSelectedCategoryChange(Sender: TObject; const Category: TButtonCategory);
   procedure PaletteCategoryClicked(Sender: TObject; const Category: TButtonCategory);
   procedure actnRenameCategoryExecute(Sender: TObject);
   procedure PaletteEdited(Sender: TObject; Item: TBaseItem; var S: string);
   procedure PaletteEditing(Sender: TObject; Item: TBaseItem; var AllowEdit: Boolean);
   procedure PaletteKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
   procedure PaletteGetHint(Sender: TObject; const Button: TButtonItem; const Category: TButtonCategory; var HintStr: string; var Handled: Boolean);
   procedure FormCreate(Sender: TObject);
