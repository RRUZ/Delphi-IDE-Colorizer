type
  TFileFilterMenuItem=class(TMenuItem)
  private
  ...
  public
   constructor Create(AOwner: TComponent; AEditBuffer: TEditBuffer; const AFilter: IOTAFileFilter);
   ...
   class destructor Destroy;
   property EditBuffer: TEditBuffer;
   property Filter: IOTAFileFilter;
