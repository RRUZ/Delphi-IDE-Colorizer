type
  TCallStackWindow=class(TDockableForm)
  private
   CallList            :TList;
   CallStackStunned    :Boolean;
   cxM                 :Integer;
   FFullQualStack      :Boolean;
   ...
   function GetHeaderText(CallIndex: Integer): string;
  ...
  public
   ...
   procedure ThreadDebugUpdate(Sender: TObject; const Thread: IOTAThread);
   procedure TerminateDebugUpdate(Sender: TObject; const Process: IOTAProcess);
   procedure DebuggerChanged(Sender: TObject);
  ...
  published
   CallStackTree       :TVirtualStringTree;
   CallStackMenu       :TPopupActionBar;
   csViewSource        :TMenuItem;
   csEditSource        :TMenuItem;
   LocalMenuItem       :TMenuItem;
   ZoomWindowItem      :TMenuItem;
   DockableItem        :TMenuItem;
   CloseWindowItem     :TMenuItem;
   csViewLocals        :TMenuItem;
   StayonTopItem       :TMenuItem;
   csShowQualifiedNames:TMenuItem;
   N1                  :TMenuItem;
   csToggleBreakpoint  :TMenuItem;
   ...
   procedure csShowQualifiedNamesClick(Sender: TObject);
   procedure CallStackTreeGetText(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType; var CellText: WideString);
   procedure FormCreate(Sender: TObject);
   procedure FormDestroy(Sender: TObject);
   procedure FormShow(Sender: TObject);
   procedure FormHide(Sender: TObject);
   procedure EditSourceClick(Sender: TObject);
   function RowIsVisible(Row: Cardinal): Boolean;
   procedure UpdateCallStack;
   procedure CMUpdateCallStack(var Message: tagMSG);
   procedure csViewLocalsClick(Sender: TObject);
   procedure CallStackMenuPopup(Sender: TObject);
   procedure csToggleBreakpointClick(Sender: TObject);
   procedure CallStackTreeGetImageIndex(Sender: TBaseVirtualTree; Node: PVirtualNode; Kind: TVTImageKind; Column: TColumnIndex; var Ghosted: Boolean; var ImageIndex: Integer);
   procedure csViewSourceClick(Sender: TObject);
   procedure CallStackTreeDblClick(Sender: TObject);
   procedure CallStackTreeMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X: Integer; Y: Integer);
   procedure CallStackTreeKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
   procedure CallStackTreePaintText(Sender: TBaseVirtualTree; const TargetCanvas: TCanvas; Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType);
   procedure FormCreate(Sender: TObject);
