type
  TEditorDockableForm=class(TDockableForm)
  private
  ...
  published
   ...
   procedure ViewEditorCmdExecute(Sender: TObject);
   procedure ViewEditorCmdUpdate(Sender: TObject);
   procedure FormCreate(Sender: TObject);
