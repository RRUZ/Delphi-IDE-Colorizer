type
  TRefactoringForm=class(TBaseRefactoringForm)
  private
  ...
  published
   imglstMenuBarIcon   :TImageList;
   actnlistMainMenu    :TActionList;
   actnViewRefactorings:TAction;
   menuViewRefactorings:TMenuItem;
   popMainMenuItems    :TPopupMenu;
   imglstRefactoring   :TImageList;
   actnlstRefactorings :TActionList;
   actnRefactor        :TAction;
   actnUndo            :TAction;
   actnDelete          :TAction;
   actnDeleteAll       :TAction;
   mnuPopUndo          :TMenuItem;
   mnuPopDelete        :TMenuItem;
   mnuPopDeleteAll     :TMenuItem;
   mnuSeperatorBottom  :TMenuItem;
   StayonTop1          :TMenuItem;
   Dockable1           :TMenuItem;
   refactoringTree     :TRefactoringTree;
   tlbrMain            :TToolBar;
   ToolButton1         :TToolButton;
   lblStatus           :TLabel;
   imglstRefactoringTree:TImageList;
   ...
   procedure actnViewRefactoringsExecute(Sender: TObject);
   procedure actnRefactorUpdate(Sender: TObject);
   procedure actnRefactorExecute(Sender: TObject);
   ...
   procedure refactoringTreeKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
   procedure actnDeleteAllUpdate(Sender: TObject);
   procedure actnDeleteAllExecute(Sender: TObject);
   procedure FormCreate(Sender: TObject);
   procedure refactoringTreeFreeNode(Sender: TBaseVirtualTree; Node: PVirtualNode);
   procedure refactoringTreeGetText(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType; var CellText: WideString);
   procedure refactoringTreeGetImageIndex(Sender: TBaseVirtualTree; Node: PVirtualNode; Kind: TVTImageKind; Column: TColumnIndex; var Ghosted: Boolean; var ImageIndex: Integer);
   procedure refactoringTreeGetHint(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType; var CellText: WideString);
   procedure refactoringTreeDblClick(Sender: TObject);
   procedure refactoringTreeKeyPress(Sender: TObject; var Key: Char);
   procedure FormCreate(Sender: TObject);
