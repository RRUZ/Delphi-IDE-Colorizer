type
  TDebugLogView=class(TDockableForm)
  private
   FAutoScroll         :Boolean;
   FCellTextHeight     :Cardinal;
   ...
   function GetEvent(Index: Integer): string;
  ...
  published
   LogPopupMenu        :TPopupActionBar;
   SaveLogItem         :TMenuItem;
   ClearLogItem        :TMenuItem;
   N1                  :TMenuItem;
   OptionsItem         :TMenuItem;
   AddCommentItem      :TMenuItem;
   SaveLogDlg          :TSaveTextFileDialog;
   ...
   procedure AddCommentItemClick(Sender: TObject);
   procedure FormShow(Sender: TObject);
   procedure FormDestroy(Sender: TObject);
   procedure LogTreeGetText(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType; var CellText: WideString);
   procedure LogTreePaintText(Sender: TBaseVirtualTree; const TargetCanvas: TCanvas; Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType);
   procedure LogTreeBeforeItemErase(Sender: TBaseVirtualTree; TargetCanvas: TCanvas; Node: PVirtualNode; ItemRect: TRect; var ItemColor: TColor; var EraseAction: TItemEraseAction);
   procedure LogTreeFocusChanged(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex);
   procedure LogTreeInitNode(Sender: TBaseVirtualTree; ParentNode: PVirtualNode; Node: PVirtualNode; var InitialStates: TVirtualNodeInitStates);
   procedure FormCreate(Sender: TObject);
