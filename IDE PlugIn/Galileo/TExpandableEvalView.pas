type
  TExpandableEvalView=class(TForm)
  private
   FNotifierIndex      :Integer;
   FExpressionInspector:IOTAExpressionInspector;
   FNodeExpression     :string;
   FNodeValue          :string;
   FNodeType           :string;
   FCursorRect         :TRect;
   FTimerHitsToHover   :Cardinal;
   FHoverAccumulator   :Cardinal;
   FSubInspectedNode   :PVirtualNode;
   FCollapsedNode      :PVirtualNode;
   FEditor             :TCustomEditControl;
   FEditorHook         :TEditorControlHook;
   FMouseOffsetFromRight:Integer;
   FShowRawValues      :Boolean;
  ...
  public
   ...
   class destructor Destroy;
   property ShowRawValues: Boolean;
   ...
   property TaskbarHandler: TTaskbarHandler;
  ...
  published
   TooltipTree         :TVirtualStringTree;
   MouseTrackerTimer   :TTimer;
   ExpanderFormMenu    :TPopupMenu;
   ...
   procedure TooltipTreeMouseMove(Sender: TObject; Shift: TShiftState; X: Integer; Y: Integer);
   procedure FormShow(Sender: TObject);
   procedure TooltipTreePaintText(Sender: TBaseVirtualTree; const TargetCanvas: TCanvas; Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType);
   procedure FormMouseActivate(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X: Integer; Y: Integer; HitTest: Integer; var MouseActivate: TMouseActivate);
   procedure TooltipTreeMeasureItem(Sender: TBaseVirtualTree; TargetCanvas: TCanvas; Node: PVirtualNode; var NodeHeight: Integer);
   procedure FormDestroy(Sender: TObject);
   procedure FormCreate(Sender: TObject);
   procedure CloseWindowItemClick(Sender: TObject);
   procedure MouseTrackerTimerTimer(Sender: TObject);
   procedure TooltipTreeExpanding(Sender: TBaseVirtualTree; Node: PVirtualNode; var Allowed: Boolean);
   procedure TooltipTreeInitNode(Sender: TBaseVirtualTree; ParentNode: PVirtualNode; Node: PVirtualNode; var InitialStates: TVirtualNodeInitStates);
   procedure TooltipTreeFreeNode(Sender: TBaseVirtualTree; Node: PVirtualNode);
   procedure TooltipTreeGetNodeDataSize(Sender: TBaseVirtualTree; var NodeDataSize: Integer);
   procedure TooltipTreeGetText(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType; var CellText: WideString);
   procedure FormClose(Sender: TObject; var Action: TCloseAction);
   procedure TooltipTreeGetImageIndex(Sender: TBaseVirtualTree; Node: PVirtualNode; Kind: TVTImageKind; Column: TColumnIndex; var Ghosted: Boolean; var ImageIndex: Integer);
   procedure ExpanderFormMenuPopup(Sender: TObject);
   procedure LocalInspectItemClick(Sender: TObject);
   procedure WatchItemClick(Sender: TObject);
