type
  TDumpView=class(TCustomGrid)
  private
   FTopOffset          :Int64;
   FViewType           :TViewType;
   FDataColumns        :Integer;
   FShowTextColumn     :Boolean;
   FDescending         :Boolean;
   FDataBuffer         :PByteArray;
   FCapacity           :Integer;
   FDataSize           :Integer;
  ...
  protected
   ...
   function GetDataString(ACol: Integer; ARow: Integer): string;
  public
   constructor Create(AOwner: TComponent);
   class destructor Destroy;
   function BytesPerElem: Integer;
   function BytesPerRow: Integer;
   function BytesVisible: Integer;
  ...
  published
   ...
   property DataColumns: Integer;
   property Descending: Boolean;
   property Enabled: Boolean;
   property Font: TFont;
   property LeftGutterWidth: Integer;
   property MaxOffset: Int64;
   property MinOffset: Int64;
   property ParentColor: Boolean;
   property ParentCtl3D: Boolean;
   property ParentFont: Boolean;
   property PopupMenu: TPopupMenu;
   property Previous: Int64;
   property SelectedData: string;
   property SelectedOffset: Int64;
   property ShowTextColumn: Boolean;
   property TabOrder: TTabOrder;
   property TabStop: Boolean;
   property TopOffset: Int64;
   property Visible: Boolean;
