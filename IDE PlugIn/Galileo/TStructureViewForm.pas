type
  TStructureViewForm=class(TDockableForm)
  private
   FProductStartup     :TObject;
   FAlreadyActive      :Boolean;
  ...
  protected
   FStructureNodePopup :IInterface;
   FForceAllowEdit     :Boolean;
   FLockedFromNewText  :Boolean;
   FLastParsingDots    :Integer;
   FParsingTimer       :TTimer;
   FDockable           :Boolean;
  ...
  published
   ...
   StructureActions    :TActionList;
   ViewStructureCmd    :TAction;
   PopupMenu1          :TPopupMenu;
   ViewStructureItem   :TMenuItem;
   NodePopupMenu       :TPopupActionBar;
   DockableItem        :TMenuItem;
   StayonTopItem       :TMenuItem;
   StateImages         :TImageList;
   StructureToolbar    :TToolBar;
   ToolBarActions      :TActionList;
   ...
   procedure VirtualStringTree1CompareNodeCaption(Sender: TBaseVirtualTree; Node1: PVirtualNode; Node2: PVirtualNode; Column: TColumnIndex; var Result: Integer);
   procedure VirtualStringTree1CompareNodeIndex(Sender: TBaseVirtualTree; Node1: PVirtualNode; Node2: PVirtualNode; Column: TColumnIndex; var Result: Integer);
   procedure VirtualStringTree1IncrementalSearch(Sender: TBaseVirtualTree; Node: PVirtualNode; const SearchText: WideString; var Result: Integer);
   procedure VirtualStringTree1EditCancelled(Sender: TBaseVirtualTree; Column: TColumnIndex);
   procedure VirtualStringTree1Edited(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex);
   procedure VirtualStringTree1StateChange(Sender: TBaseVirtualTree; Enter: TVirtualTreeStates; Leave: TVirtualTreeStates);
   procedure ViewStructureCmdExecute(Sender: TObject);
   ...
   procedure VirtualStringTree1InitNode(Sender: TBaseVirtualTree; ParentNode: PVirtualNode; Node: PVirtualNode; var InitialStates: TVirtualNodeInitStates);
   ...
   procedure VirtualStringTree1NewText(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex; NewText: WideString);
   ...
   procedure VirtualStringTree1FocusChanging(Sender: TBaseVirtualTree; OldNode: PVirtualNode; NewNode: PVirtualNode; OldColumn: TColumnIndex; NewColumn: TColumnIndex; var Allowed: Boolean);
   ...
   procedure VirtualStringTree1DragDrop(Sender: TBaseVirtualTree; Source: TObject; DataObject: IDataObject; Formats: TFormatArray; Shift: TShiftState; Pt: TPoint; var Effect: Integer; Mode: TDropMode);
   procedure VirtualStringTree1CreateDataObject(Sender: TBaseVirtualTree; out DataObject: IDataObject);
   procedure VirtualStringTree1KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
   procedure VirtualStringTree1KeyAction(Sender: TBaseVirtualTree; var CharCode: Word; var Shift: TShiftState; var DoDefault: Boolean);
   procedure VirtualStringTree1DblClick(Sender: TObject);
   procedure DefaultNodeAction(Sender: TBaseVirtualTree);
