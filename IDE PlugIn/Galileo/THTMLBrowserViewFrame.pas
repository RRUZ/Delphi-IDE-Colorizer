type
  THTMLBrowserViewFrame=class(TFrame)
  private
   FAllowBrowsing      :Boolean;
   FLastBrowserContent :string;
   FWaitDocumentComplete:Boolean;
   FTempFileName       :string;
   FTempURL            :string;
   FHaveTempURL        :Boolean;
   FHaveUIHandler      :Boolean;
   FHaveSubclass       :Boolean;
   FCurrentRoot        :TComponent;
   FCurrentContext     :IInterface;
  ...
  published
   ...
   ActionCheckComplete :TAction;
   Button1             :TButton;
   Refresh             :TAction;
   PopupMenu1          :TPopupMenu;
   procedure ActionCheckCompleteExecute(Sender: TObject);
   procedure ActionCheckCompleteUpdate(Sender: TObject);
   procedure RefreshExecute(Sender: TObject);
   procedure RefreshUpdate(Sender: TObject);
   procedure WebBrowserBeforeNavigate2(Sender: TObject; const pDisp: IDispatch; var URL: OleVariant; var Flags: OleVariant; var TargetFrameName: OleVariant; var PostData: OleVariant; var Headers: OleVariant; var Cancel: WordBool);
   property Align: TAlign;
   property Anchors: TAnchors;
