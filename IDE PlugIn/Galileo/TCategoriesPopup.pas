type
  TCategoriesPopup=class(TPopupWindow)
  private
  ...
  public
   ...
   constructor Create(AOwner: TComponent);
   procedure Popup(const X: Integer; const Y: Integer);
   constructor Create(AOwner: TComponent);
   ...
   class destructor Destroy;
   property CategoryButtons: TCategoryButtons;
   property ButtonGroup: TButtonGroup;
