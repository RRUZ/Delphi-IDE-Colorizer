type
  TDataExplorerDockForm=class(TDockableForm)
  private
  ...
  published
   ...
   ViewDataExplorerCmd :TAction;
   PopupMenu1          :TPopupMenu;
   ViewDataExplorerMenuItem:TMenuItem;
   ...
   procedure ViewDataExplorerCmdExecute(Sender: TObject);
