type
  TCastaliaNavToolbar=class(TToolBar)
  private
   FProxy              :ICastaliaEditorProxy;
   FPainter            :ICastaliaEditorPainter;
   FCodeTree           :PCastaliaCodeStructuralItem;
   FListenerID         :Integer;
   FCodeListenerID     :Integer;
   FUnitsMenu          :TCastaliaNavToolbarPopupMenu;
   FUnitsBtn           :TToolButton;
   FSectionsMenu       :TCastaliaNavToolbarPopupMenu;
   FSectionsBtn        :TToolButton;
   FBookmarkStackMenu  :TPopupMenu;
   FProjectSearchButton:TToolButton;
   FClassDropdown      :TCastaliaNavToolbarDropdown;
   FMethodDropdown     :TCastaliaNavToolbarDropdown;
   FCurrentListBox     :TListBox;
   FAutoComplete       :Boolean;
   FLastLine           :Integer;
   FLastCol            :Integer;
   FTimer              :TTimer;
   FLastOpenModule     :Pointer;
   FMenuOpen           :Boolean;
   FTempClasses        :TStrings;
   FTempMethods        :TStrings;
   FCaretX             :Integer;
   FCaretY             :Integer;
   FNeedsReset         :Boolean;
   FBitmap             :TBitmap;
  ...
  public
   ...
   procedure SetupProxy(AProxy: ICastaliaEditorProxy);
   procedure ResetNavbar(AProxy: ICastaliaEditorProxy; Reparsed: Boolean; ParseTree: PCastaliaCodeStructuralItem);
   procedure EditorTimer(AProxy: ICastaliaEditorProxy; Reparsed: Boolean);
   procedure EditorBeforePaint(AProxy: ICastaliaEditorProxy);
   procedure EditorAfterPaint(AProxy: ICastaliaEditorProxy);
   procedure EditorLeftClick(AProxy: ICastaliaEditorProxy; Keys: Cardinal; CursorPos: TPoint; var Handled: Boolean);
   procedure EditorLeftDblClick(AProxy: ICastaliaEditorProxy; Keys: Cardinal; CursorPos: TPoint; var Handled: Boolean);
   procedure EditorRightClick(AProxy: ICastaliaEditorProxy; Keys: Cardinal; CursorPos: TPoint; var Handled: Boolean);
   procedure EditorRightDblClick(AProxy: ICastaliaEditorProxy; Keys: Cardinal; CursorPos: TPoint; var Handled: Boolean);
   procedure EditorKeyDown(AProxy: ICastaliaEditorProxy; KeyCode: Integer; KeyData: Cardinal; var Handled: Boolean);
   procedure EditorKeyUp(AProxy: ICastaliaEditorProxy; KeyCode: Integer; KeyData: Cardinal; var Handled: Boolean);
   procedure EditorChar(AProxy: ICastaliaEditorProxy; CharacterCode: Char; KeyData: Cardinal; var Handled: Boolean);
   procedure EditorVScroll(AProxy: ICastaliaEditorProxy);
   procedure EditorHScroll(AProxy: ICastaliaEditorProxy);
   procedure EditorMouseMove(AProxy: ICastaliaEditorProxy; Keys: Cardinal; CursorPos: TPoint; var Handled: Boolean);
   procedure EditorPaintLine(AProxy: ICastaliaEditorProxy; ALine: Integer);
   procedure EditorKeyPress(AProxy: ICastaliaEditorProxy; var AKey: Char; var Handled: Boolean);
   procedure EditorContentsModified(AProxy: ICastaliaEditorProxy);
   procedure EditorViewActivated(AProxy: ICastaliaEditorProxy; AView: IOTAEditView);
   procedure ActiveViewUpdated(AProxy: ICastaliaEditorProxy);
   procedure Standby;
   procedure Reparsed(CodeTree: PCastaliaCodeStructuralItem);
   constructor Create(AOwner: TComponent);
   class destructor Destroy;
