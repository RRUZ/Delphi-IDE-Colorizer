type
  TBetterHintWindowVirtualDrawTree=class(TVirtualDrawTree)
  private
   FHintData           :PVirtualNode;
   FZombieOnGetText    :TVSTGetTextEvent;
   ...
   function ZombieGetText(Node: PVirtualNode; Column: TColumnIndex): WideString;
  ...
  published
   ...
   property ZombieOnGetText: TVSTGetTextEvent;
