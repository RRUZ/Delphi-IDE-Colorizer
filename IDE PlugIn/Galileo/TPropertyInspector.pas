type
  TPropertyInspector=class(TDockableForm)
  private
   FPropInspSelection  :IOTAPropInspSelection;
   FPropInspServices   :IOTAPropInspServices;
   FNotifierIndex      :Integer;
   FSavedCaption       :string;
   FErrorMessage       :string;
   FExpandedItems      :TStrings;
   FIntegralSizing     :Boolean;
   FReferenceOnEvents  :Boolean;
   FShowClassnames     :Boolean;
   FInstanceListNameColor:TColor;
   FInstanceListClassnameColor:TColor;
  ...
  protected
   ...
   function get_MDIChildren(I: Integer): TForm;
  public
   procedure RethinkSize;
   procedure DestroyWnd;
   procedure AcceptEdit;
   procedure BeginSelectionChange;
   procedure DoUpdate;
   procedure EndSelectionChange;
   procedure Validate;
   procedure DoActivate;
   procedure DoExpandAll;
   function EditAction(Action: TEditAction): Boolean;
   function GetEditState: TEditState;
   procedure ModalEdit(Sender: TObject; EditKey: Char; const ReturnWindow: IActivatable);
   procedure SelectItemName(Sender: TObject; const Value: string);
   ...
   class destructor Destroy;
   property SelectionChanging: Boolean;
  ...
  published
   LocalPopupMenu      :TPopupActionBar;
   Stayontop           :TMenuItem;
   Help1               :TMenuItem;
   ...
   Collapse            :TMenuItem;
   Revert              :TMenuItem;
   InstanceListPanel   :TPanel;
   PaintBox1           :TPaintBox;
   InstanceList        :TListButton;
   N1                  :TMenuItem;
   DockableItem        :TMenuItem;
   N2                  :TMenuItem;
   ArrangeWhat         :TMenuItem;
   ArrangeByCategory   :TMenuItem;
   ArrangeByName       :TMenuItem;
   ViewWhat            :TMenuItem;
   ViewBar             :TMenuItem;
   ViewAll             :TMenuItem;
   ViewNone            :TMenuItem;
   InspectorActions    :TActionManager;
   ArrangeByCategoryCmd:TAction;
   ArrangeByNameCmd    :TAction;
   ViewAllCmd          :TAction;
   ViewNoneCmd         :TAction;
   ViewToggle          :TMenuItem;
   ...
   Panel3              :TPanel;
   TabControl          :TCodeEditorTabControl;
   PropList            :TInspListBox;
   PopupMenu1          :TPopupMenu;
   ActionList1         :TActionList;
   ViewObjInspCommand  :TAction;
   ViewObjInspItem     :TMenuItem;
   DescriptionPane     :TDescriptionPane;
   DescriptSplitter    :TSplitter;
   HotCommands         :THotCommands;
   CommandSplitter     :TSplitter;
   ...
   procedure SwitchTabPage(Sender: TObject);
   procedure Help1Click(Sender: TObject);
   procedure LocalPopupMenuPopup(Sender: TObject);
   procedure ExpandClick(Sender: TObject);
   procedure CollapseClick(Sender: TObject);
   procedure RevertClick(Sender: TObject);
   procedure PaintBox1Paint(Sender: TObject);
   procedure PaintBox1MouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X: Integer; Y: Integer);
   procedure TabControlResize(Sender: TObject);
   procedure InstanceListPanelResize(Sender: TObject);
   procedure InstanceDropDown(Sender: TObject; var CanDrop: Boolean);
   procedure InstanceAccept(Sender: TObject);
   procedure InstanceCancel(Sender: TObject);
   procedure PropListHelp(Sender: TObject);
   procedure PropListEditDblClick(Sender: TObject; DblClick: Boolean);
   procedure PropListKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
   procedure FormDestroy(Sender: TObject);
   procedure FormActivate(Sender: TObject);
   procedure FormDeactivate(Sender: TObject);
   procedure ViewWhatClick(Sender: TObject);
   procedure ArrangeByNameCmdUpdate(Sender: TObject);
   procedure ArrangeByNameCmdExecute(Sender: TObject);
   procedure ArrangeByCategoryCmdExecute(Sender: TObject);
   procedure ArrangeByCategoryCmdUpdate(Sender: TObject);
   procedure ViewAllCmdExecute(Sender: TObject);
   procedure ViewNoneCmdExecute(Sender: TObject);
   procedure ViewToggleClick(Sender: TObject);
   procedure PropertyInspectorActivate(Sender: TObject);
   procedure FormStartDock(Sender: TObject; var DragObject: TDragDockObject);
   procedure InstanceListDrawItem(Control: TWinControl; Index: Integer; Rect: TRect; State: TOwnerDrawState);
   procedure InstanceListMeasureHeight(Control: TWinControl; Index: Integer; var Height: Integer);
   procedure StayOnTopCmdExecute(Sender: TObject);
   procedure ShowPropertiesExecute(Sender: TObject);
   procedure PropListGetSubProperties(Sender: TObject; const Prop: IProperty; GetPropProc: TGetPropProc = procedure(const Prop: IProperty) of object);
   procedure PropListTestSelection(Sender: TObject; const Prop: IProperty; var Result: Boolean);
   procedure PropListSelectItem(Sender: TObject);
   procedure PropListAfterReset(Sender: TObject);
   procedure ViewObjInspCommandExecute(Sender: TObject);
   procedure FormShow(Sender: TObject);
   procedure HotCommandsLabelClick(Sender: TObject; CommandIndex: Integer);
   procedure FormCreate(Sender: TObject);
   ...
   property ActiveComponentName: WideString;
   property ActiveComponentType: WideString;
   property ActivePage: string;
   property ActivePropName: WideString;
   property ActivePropValue: WideString;
   property CurInstanceName: WideString;
   property PropertyList: TInspListBox;
   property ArrangeMode: TInspArrangeMode;
   property ZombieInstanceList: TListButton;
   property Action: TBasicAction;
   property ActiveControl: TWinControl;
   property Align: TAlign;
