type
  TXMMRegisterView=class(TLabeledList)
  private
   FOldRegs            :TXMMRegs;
   FCurrentRegs        :TXMMRegs;
   FShowOldRegs        :Boolean;
   FRegsViewType       :TRegisterViewType;
   FVisibleRegs        :TVisibleXMMRegs;
  ...
  public
   ...
   procedure UpdateRegisters(NewRegisters: TXMMRegs);
  ...
  published
   ...
   property CurrentRegs: TXMMRegs;
   property Enabled: Boolean;
   property Font: TFont;
   property OldRegs: TXMMRegs;
   property ParentColor: Boolean;
   property ParentCtl3D: Boolean;
   property ParentFont: Boolean;
   property PopupMenu: TPopupMenu;
   property Radix: TFPURadix;
   property SelectedRegister: TXMMRegisterType;
   property SelectedRegisterRow: Integer;
   property ShowOldRegs: Boolean;
   property TabOrder: TTabOrder;
   property TabStop: Boolean;
   property ViewType: TViewType;
   property Visible: Boolean;
   property VisibleRegs: TVisibleXMMRegs;
