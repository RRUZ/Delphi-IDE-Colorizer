type
  THotCommands=class(TCustomHotCommands)
  private
   FCommands           :TStrings;
   FOnHotCommandClick  :THotCommandClickEvent;
   FRecreatingLabels   :Boolean;
   FFreeLabels         :TComponentList;
   ...
   function GetCommandState(Index: Integer): Boolean;
   procedure SetCommandState(Index: Integer; Value: Boolean);
  ...
  published
   ...
   property OnHotCommandClick: THotCommandClickEvent;
