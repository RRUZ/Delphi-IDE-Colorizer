type
  THistoryPropComboBox=class(TPropComboBox)
  private
   FHistoryManager     :TCustomHistoryManager;
   FHistoryList        :string;
   FPropLink           :TFieldPropLink;
  ...
  published
   property HistoryManager: TCustomHistoryManager;
   property HistoryList: string;
   property Items: TStrings;
   ...
   property PropField: TFieldName;
   property PropSet: TCustomPropSet;
   ...
   property OnGetHintText: TGetHintTextEvent;
