type
  TListButton=class(TCustomControl)
  private
   FListBox            :TListBox;
   FPopupPanel         :TCustomForm;
   FGlyph              :TBitmap;
   FDisabledGlyph      :TBitmap;
   FDropAlign          :TDropAlign;
   FAutoWidth          :Boolean;
   FListWidth          :Integer;
   ...
   FOnMeasureWidth     :TListButtonListWidthEvent;
   FOnMeasureHeight    :TMeasureItemEvent;
   FOnDrawItem         :TDrawItemEvent;
   FDown               :Boolean;
   FPressed            :Boolean;
   FViaKillFocus       :Boolean;
   FSelectString       :WideString;
   FCanvas             :TCanvas;
   ...
   function GetItemTextA(Index: Integer): string;
  ...
  public
   ...
   procedure DropDown;
   procedure DropDown(Control: TControl);
   procedure CloseUp(Accept: Boolean);
   function ListCanvas: TCanvas;
   constructor Create(AOwner: TComponent);
   class destructor Destroy;
   constructor Create(AOwner: TComponent);
  ...
  published
   ...
   property DropAlign: TDropAlign;
   property Enabled: Boolean;
   property Font: TFont;
   property Glyph: TBitmap;
   property Items: TStrings;
   property ItemIndex: Integer;
   property ListWidth: Integer;
   ...
   property OnMeasureWidth: TListButtonListWidthEvent;
   property OnMeasureHeight: TMeasureItemEvent;
