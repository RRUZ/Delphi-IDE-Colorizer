type
  TToDoListWindow=class(TDockableForm)
  private
   FShowHints          :Boolean;
   FSelectedRow        :Integer;
   FHeaderPressed      :Integer;
  ...
  public
   ...
   class destructor Destroy;
   property SortOrder: TToDoSortOrder;
   property ShowChecked: Boolean;
  ...
  published
   GridPopup           :TPopupActionBar;
   ActionList          :TActionList;
   ImageList           :TImageList;
   N3                  :TMenuItem;
   DeleteAction        :TAction;
   EditToDoItem        :TMenuItem;
   DeleteToDoItem      :TMenuItem;
   Dockable1           :TMenuItem;
   EditAction          :TAction;
   OpenAction          :TAction;
   AddAction           :TAction;
   AddToDoItem         :TMenuItem;
   Grid                :TTDStringGrid;
   Open1               :TMenuItem;
   ShowHintsAction     :TAction;
   ShowHints1          :TMenuItem;
   ShowCheckedAction   :TAction;
   ShowChecked1        :TMenuItem;
   N1                  :TMenuItem;
   Sort1               :TMenuItem;
   SortActionItem      :TMenuItem;
   SortChecked         :TMenuItem;
   SortKind            :TMenuItem;
   SortPriority        :TMenuItem;
   SortModule          :TMenuItem;
   SortOwner           :TMenuItem;
   SortCategory        :TMenuItem;
   FilterCategoryAction:TAction;
   FilterOwnersAction  :TAction;
   FilterKindsAction   :TAction;
   Filter1             :TMenuItem;
   Categories1         :TMenuItem;
   Owners1             :TMenuItem;
   ItemTypes1          :TMenuItem;
   Copy1               :TMenuItem;
   CopyAsTextAction    :TAction;
   CopyToDoListAsTextItem:TMenuItem;
   CopyAsTableAction   :TAction;
   CopyToDoListAsTableItem:TMenuItem;
   TableOptionsAction  :TAction;
   TableOptions1       :TMenuItem;
   N4                  :TMenuItem;
   Status              :TStatusBar;
   ...
   procedure ToDoItemsUpdate(Sender: TObject);
   procedure DeleteActionExecute(Sender: TObject);
   procedure GridDrawCell(Sender: TObject; ACol: Integer; ARow: Integer; Rect: TRect; State: TGridDrawState);
   procedure GridSelectCell(Sender: TObject; ACol: Integer; ARow: Integer; var CanSelect: Boolean);
   procedure GridMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X: Integer; Y: Integer);
   procedure EditActionExecute(Sender: TObject);
   procedure OpenActionExecute(Sender: TObject);
   procedure AddActionExecute(Sender: TObject);
   procedure GridMouseMove(Sender: TObject; Shift: TShiftState; X: Integer; Y: Integer);
   procedure GridDblClick(Sender: TObject);
   procedure GridHint(Sender: TObject; HintInfo: PHintInfo);
   procedure ShowHintsActionExecute(Sender: TObject);
   procedure ShowCheckedActionExecute(Sender: TObject);
   procedure SortAlphaActionUpdate(Sender: TObject);
   procedure FormDestroy(Sender: TObject);
   procedure GridMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X: Integer; Y: Integer);
   procedure FilterCategoryActionExecute(Sender: TObject);
   procedure SortCategoryClick(Sender: TObject);
   procedure TableOptionsActionExecute(Sender: TObject);
   procedure CopyAsTableActionExecute(Sender: TObject);
   procedure CopyAsTextActionExecute(Sender: TObject);
