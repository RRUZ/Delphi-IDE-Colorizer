type
  TMessageViewForm=class(TDockableForm)
  private
   FMsgViews           :TList;
   FCompiling          :Boolean;
   ...
   function GetMsgView(Index: Integer): TVirtualDrawTree;
  ...
  public
   ...
   function CurMessageView: TVirtualDrawTree;
   function GetCurrentMessageViewName: string;
   procedure GetSaveStrings(SaveStringList: TStrings; MessageGroup: IMessageGroup; Level: Integer);
   class procedure NextMessage(GoForward: Boolean);
   class procedure NextErrorMessage(GoForward: Boolean; ErrorsOnly: Boolean; CanShowSource: Boolean);
   class procedure ShowFirstFind(const ABuffer: IMessageGroup);
   class procedure SelectLine(Line: TLine);
   class function OpenMsgView(const WhichGroup: IMessageGroup): TMessageViewForm;
   class procedure HideMsgViews;
   constructor Create(AOwner: TComponent);
   procedure ForceShow;
  ...
  published
   MsgViewPopupMenu    :TPopupActionBar;
   mvViewSourceItem    :TMenuItem;
   mvAltViewSourceItem :TMenuItem;
   mvEditSourceItem    :TMenuItem;
   mvAltEditSourceItem :TMenuItem;
   N3                  :TMenuItem;
   mvSaveMessagesItem  :TMenuItem;
   SaveMsgsDlg         :TSaveTextFileDialog;
   N1                  :TMenuItem;
   mvViewEditor        :TMenuItem;
   N2                  :TMenuItem;
   DockableItem        :TMenuItem;
   ZoomWindowItem      :TMenuItem;
   MessageGroups       :TTabSet;
   mvClearMessageTab   :TMenuItem;
   mvRemoveTab         :TMenuItem;
   N4                  :TMenuItem;
   mvClearAllMessages  :TMenuItem;
   SaveAllMessages1    :TMenuItem;
   LocalMenuItem       :TMenuItem;
   NextTabItem         :TMenuItem;
   PrevTabItem         :TMenuItem;
   ImageList1          :TImageList;
   ArrowImage          :TImageList;
   EditCopyItem        :TMenuItem;
   EditSelectAll       :TMenuItem;
   AddInActionList     :TActionList;
   AddInImageList      :TImageList;
   ViewMessagesCommand :TAction;
   AddInPopupActionBar :TPopupActionBar;
   ...
   procedure mvAltViewSourceItemClick(Sender: TObject);
   procedure mvAltEditSourceItemClick(Sender: TObject);
   procedure MsgViewPopupMenuPopup(Sender: TObject);
   procedure mvSaveMessagesItemClick(Sender: TObject);
   procedure mvViewEditorClick(Sender: TObject);
   procedure DockableItemClick(Sender: TObject);
   procedure mvClearAllMessagesItemClick(Sender: TObject);
   procedure MessageGroupAdded(Sender: TObject);
   procedure MessageGroupRemoved(Sender: TObject);
   procedure MessageGroupsChange(Sender: TObject; NewTab: Integer; var AllowChange: Boolean);
   procedure mvClearMessageTabClick(Sender: TObject);
   procedure mvRemoveTabClick(Sender: TObject);
   ...
   procedure MsgViewDrawNode(Sender: TBaseVirtualTree; const PaintInfo: TVTPaintInfo);
   procedure MsgViewInitNode(Sender: TBaseVirtualTree; ParentNode: PVirtualNode; Node: PVirtualNode; var InitialStates: TVirtualNodeInitStates);
   procedure MsgViewInitChildren(Sender: TBaseVirtualTree; Node: PVirtualNode; var ChildCount: Cardinal);
   procedure MsgViewDblClick(Sender: TObject);
   procedure MsgViewGetNodeWidth(Sender: TBaseVirtualTree; HintCanvas: TCanvas; Node: PVirtualNode; Column: TColumnIndex; var NodeWidth: Integer);
   procedure MsgViewFocusChanged(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex);
   procedure ZombieMsgViewGetText(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType; var CellText: WideString);
   procedure MessageGroupsMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X: Integer; Y: Integer);
   procedure FormCreate(Sender: TObject);
   procedure ViewMessagesCommandExecute(Sender: TObject);
   procedure FormCreate(Sender: TObject);
   ...
   property CurrentMessageViewName: string;
   property Action: TBasicAction;
   property ActiveControl: TWinControl;
   property Align: TAlign;
