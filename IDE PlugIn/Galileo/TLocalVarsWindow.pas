type
  TLocalVarsWindow=class(TDockableForm)
  private
   FInspector          :IOTAExpressionInspector;
   FDebugger           :IOTADebuggerLocalVariables;
   FUpdateFrame        :Boolean;
   FNotifierIndex      :Integer;
   FDeferredInsp       :Boolean;
  ...
  public
   ...
   procedure DebugUpdate(Sender: TObject; const Process: IOTAProcess);
   ...
   procedure CurrentThreadChanged(Sender: TObject; const Process: IOTAThread);
  ...
  published
   LocalsPopupMenu     :TPopupActionBar;
   lvInspect           :TMenuItem;
   N1                  :TMenuItem;
   lvStayOnTop         :TMenuItem;
   ...
   FramePanel          :TPanel;
   cbContext           :TComboBox;
   AltInspect          :TMenuItem;
   LocalsTreeView      :TVirtualStringTree;
   lvCopyName          :TMenuItem;
   lvCopyValue         :TMenuItem;
   N2                  :TMenuItem;
   lvWatch             :TMenuItem;
   lvEvaluateModify    :TMenuItem;
   ImageList1          :TImageList;
   VisualizerPopupMenu :TPopupMenu;
   lvVisualizers       :TMenuItem;
   ...
   procedure lvCopyValueClick(Sender: TObject);
   procedure lvCopyNameClick(Sender: TObject);
   procedure LocalsTreeViewPaintText(Sender: TBaseVirtualTree; const TargetCanvas: TCanvas; Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType);
   procedure LocalsTreeViewFreeNode(Sender: TBaseVirtualTree; Node: PVirtualNode);
   procedure OnExpandedCollapsed(Sender: TBaseVirtualTree; Node: PVirtualNode);
   procedure LocalsTreeViewInitChildren(Sender: TBaseVirtualTree; Node: PVirtualNode; var ChildCount: Cardinal);
   procedure LocalsTreeViewGetNodeDataSize(Sender: TBaseVirtualTree; var NodeDataSize: Integer);
   procedure FormShow(Sender: TObject);
   procedure FormHide(Sender: TObject);
   procedure lvInspectClick(Sender: TObject);
   procedure LocalsPopupMenuPopup(Sender: TObject);
   procedure cbContextDropDown(Sender: TObject);
   procedure cbContextChange(Sender: TObject);
   procedure FramePanelResize(Sender: TObject);
   procedure LocalsTreeViewGetText(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType; var CellText: WideString);
   procedure LocalsTreeViewInitNode(Sender: TBaseVirtualTree; ParentNode: PVirtualNode; Node: PVirtualNode; var InitialStates: TVirtualNodeInitStates);
   procedure LocalsTreeViewStartDrag(Sender: TObject; var DragObject: TDragObject);
   procedure LocalsTreeViewDragAllowed(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex; var Allowed: Boolean);
   procedure lvWatchClick(Sender: TObject);
   procedure lvEvaluateModifyClick(Sender: TObject);
   procedure LocalsTreeViewGetImageIndex(Sender: TBaseVirtualTree; Node: PVirtualNode; Kind: TVTImageKind; Column: TColumnIndex; var Ghosted: Boolean; var ImageIndex: Integer);
   procedure LocalsTreeViewMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X: Integer; Y: Integer);
