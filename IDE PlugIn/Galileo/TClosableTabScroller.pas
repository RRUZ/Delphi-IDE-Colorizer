type
  TClosableTabScroller=class(TTabScroller)
  private
   FCloseButton        :TGradientButton;
   FDropDownButton     :TGradientButton;
  ...
  public
   ...
   class destructor Destroy;
   property CloseButton: TGradientButton;
   property DropDownButton: TGradientButton;
