type
  TRegisterView=class(TLabeledList)
  private
   FOldRegs            :TCPURegs;
   FCurrentRegs        :TCPURegs;
   FShowOldRegs        :Boolean;
   FRegsViewType       :TRegisterViewType;
   FVisibleRegs        :TVisibleCPURegs;
  ...
  public
   ...
   procedure UpdateRegisters(NewRegisters: TCPURegs);
  ...
  published
   ...
   property CurrentRegs: TCPURegs;
   property Enabled: Boolean;
   property Font: TFont;
   property OldRegs: TCPURegs;
   property ParentColor: Boolean;
   property ParentCtl3D: Boolean;
   property ParentFont: Boolean;
   property PopupMenu: TPopupMenu;
   property SelectedRegister: TRegisterType;
   property SelectedRegisterRow: Integer;
   property ShowOldRegs: Boolean;
   property TabOrder: TTabOrder;
   property TabStop: Boolean;
   property Visible: Boolean;
   property VisibleRegs: TVisibleCPURegs;
