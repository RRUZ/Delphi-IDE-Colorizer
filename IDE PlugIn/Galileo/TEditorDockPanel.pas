type
  TEditorDockPanel=class(TPanel)
  private
   FSplitter           :TSplitter;
   FNextControl        :TControl;
   FResizeSuspended    :Boolean;
  ...
  public
   ...
   procedure LoadState(const Desktop: TCustomIniFile; const SizeSection: string; const ClientSection: string; const DataSection: string; DesktopForm: TDesktopForm);
   procedure SaveState(const Desktop: TCustomIniFile; const IsProject: Boolean; const SizeSection: string; const ClientSection: string; const DataSection: string; DesktopForm: TDesktopForm);
   constructor Create(AOwner: TComponent);
   ...
   class destructor Destroy;
   property ResizeSuspended: Boolean;
  ...
  published
   property DockCaptionOrientation: TDockCaptionOrientation;
   property NextControl: TControl;
   property Splitter: TSplitter;
   property Align: TAlign;
