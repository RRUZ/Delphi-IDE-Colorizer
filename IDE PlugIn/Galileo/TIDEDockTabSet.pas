type
  TIDEDockTabSet=class(TDockTabSet)
  private
   FUpdatesDisabled    :Boolean;
   FAutoSelect         :Boolean;
  ...
  public
   procedure LoadState(const Desktop: TCustomIniFile; const ClientSection: string; DesktopForm: TDesktopForm);
   procedure SaveState(const Desktop: TCustomIniFile; const IsProject: Boolean; const ClientSection: string; DesktopForm: TDesktopForm);
   constructor Create(AOwner: TComponent);
   class destructor Destroy;
   procedure ShowDockClient(const Client: TControl);
   function IndexOfDockClient(const Client: TControl): Integer;
   procedure HideCurrentDockClient(const AnimateSpeed: Integer);
   constructor Create(AOwner: TComponent);
   class destructor Destroy;
   ...
   function MinClientRect(IncludeScroller: Boolean): TRect;
   function MinClientRect(TabCount: Integer; IncludeScroller: Boolean): TRect;
  ...
  published
   ...
   property OnTabAdded: TNotifyEvent;
   property OnTabRemoved: TNotifyEvent;
   property Align: TAlign;
   property Anchors: TAnchors;
   ...
   property Style: TTabSetTabStyle;
   ...
   property OnDrawTab: TTabSetDrawTabEvent;
