type
  TWatchWindow=class(TDockableForm)
  private
   FCurEvalWatch       :Integer;
   FDeferredEval       :Boolean;
   FNotifierIndex      :Integer;
   FInplaceEditing     :Boolean;
   FTreeState          :TTreeNodeArray;
   FTreeStateTopNode   :string;
   FLoadingTreeState   :Boolean;
   ...
   function GetWatchExpression(Index: Integer): string;
   function GetWatchValue(Index: Integer): string;
  ...
  protected
   ...
   function get_MDIChildren(I: Integer): TForm;
  public
   function GetCurrentWatch: PWatchItem;
   procedure DebugUpdate(Sender: TObject);
   procedure RunProcessDebugUpdate(Sender: TObject; const Process: IOTAProcess);
   procedure StopProcessDebugUpdate(Sender: TObject; const Process: IOTAProcess);
   procedure ProcessMemoryChanged(Sender: TObject; EIPChanged: Boolean);
   procedure ProcessChangedDebugUpdate(Sender: TObject; const Process: IOTAProcess);
   procedure ThreadListChanged(Sender: TObject; const Process: IOTAProcess);
   procedure ThreadChangedDebugUpdate(Sender: TObject; const Thread: IOTAThread);
   procedure CurrentDebuggerChanged(Sender: TObject);
   procedure VisualizerListChanged(Sender: TObject);
   procedure DWBPChanged(Sender: TObject);
   procedure AddWatch(const Watch: string; aTabName: string);
   procedure EditWatch;
   ...
   procedure EvaluateComplete(const ExprStr: string; const ResultStr: string; CanModify: Boolean; ResultAddress: UInt64; ResultSize: Cardinal; ReturnCode: Integer);
   procedure InspectComplete(const ExpressionInspector: IOTAExpressionInspector);
   procedure SubInspectComplete(const ExpressionInspector: IOTAExpressionInspector);
   procedure RefreshComplete(const ExpressionInspector: IOTAExpressionInspector);
  ...
  published
   WatchMenu           :TPopupActionBar;
   EditWatchItem       :TMenuItem;
   AddWatchItem        :TMenuItem;
   RemoveWatchItem     :TMenuItem;
   EnableWatch         :TMenuItem;
   DisableWatch        :TMenuItem;
   EnableAllWatches    :TMenuItem;
   DisableAllWatches   :TMenuItem;
   DeleteAllWatches    :TMenuItem;
   LocalMenuItem       :TMenuItem;
   ZoomWindowItem      :TMenuItem;
   AltAddWatchItem     :TMenuItem;
   AltRemoveWatchItem  :TMenuItem;
   AltEditWatchItem    :TMenuItem;
   N3                  :TMenuItem;
   ...
   LocalInspectItem    :TMenuItem;
   N5                  :TMenuItem;
   DeleteGroup         :TMenuItem;
   AddGroup            :TMenuItem;
   WatchTabs           :TTabSet;
   MoveWatchToGroup    :TMenuItem;
   NextTabItem         :TMenuItem;
   PrevTabItem         :TMenuItem;
   N6                  :TMenuItem;
   mnuShowColHeaders   :TMenuItem;
   CopyWatchValue      :TMenuItem;
   CopyWatchName       :TMenuItem;
   WatchTree           :TVirtualStringTree;
   N7                  :TMenuItem;
   EvaluateModifyItem  :TMenuItem;
   NewWatchItem        :TMenuItem;
   ImageList1          :TImageList;
   VisualizerPopupMenu :TPopupMenu;
   VisualizersItem     :TMenuItem;
   ...
   procedure OnExpandedCollapsed(Sender: TBaseVirtualTree; Node: PVirtualNode);
   procedure WatchTreeInitChildren(Sender: TBaseVirtualTree; Node: PVirtualNode; var ChildCount: Cardinal);
   procedure WatchTreeFreeNode(Sender: TBaseVirtualTree; Node: PVirtualNode);
   procedure WatchTreeGetNodeDataSize(Sender: TBaseVirtualTree; var NodeDataSize: Integer);
   procedure FormCreate(Sender: TObject);
   procedure EditButtonClick(Sender: TObject);
   procedure DeleteButtonClick(Sender: TObject);
   procedure ClearButtonClick(Sender: TObject);
   procedure AddWatchItemClick(Sender: TObject);
   procedure EnableDisableAllWatchesClick(Sender: TObject);
   procedure WatchMenuPopup(Sender: TObject);
   procedure EnableWatchClick(Sender: TObject);
   procedure DisableWatchClick(Sender: TObject);
   procedure BreakItemClick(Sender: TObject);
   procedure FormShow(Sender: TObject);
   procedure FormHide(Sender: TObject);
   procedure LocalInspectItemClick(Sender: TObject);
   procedure AddGroupClick(Sender: TObject);
   procedure DeleteGroupClick(Sender: TObject);
   procedure WatchTabsChange(Sender: TObject; NewTab: Integer; var AllowChange: Boolean);
   procedure NextTabItemClick(Sender: TObject);
   procedure PrevTabItemClick(Sender: TObject);
   procedure mnuShowColHeadersClick(Sender: TObject);
   procedure FormDestroy(Sender: TObject);
   procedure CopyWatchValueClick(Sender: TObject);
   procedure CopyWatchNameClick(Sender: TObject);
   procedure WatchTreeGetText(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType; var CellText: WideString);
   procedure WatchTreeInitNode(Sender: TBaseVirtualTree; ParentNode: PVirtualNode; Node: PVirtualNode; var InitialStates: TVirtualNodeInitStates);
   procedure WatchTreePaintText(Sender: TBaseVirtualTree; const TargetCanvas: TCanvas; Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType);
   procedure WatchTreeNewText(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex; NewText: WideString);
   procedure WatchTreeChecked(Sender: TBaseVirtualTree; Node: PVirtualNode);
   procedure WatchTreeEditing(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex; var Allowed: Boolean);
   procedure WatchTreeDblClick(Sender: TObject);
   procedure WatchTreeEdited(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex);
   procedure WatchTreeEditCancelled(Sender: TBaseVirtualTree; Column: TColumnIndex);
   procedure WatchTreeDragOver(Sender: TBaseVirtualTree; Source: TObject; Shift: TShiftState; State: TDragState; Pt: TPoint; Mode: TDropMode; var Effect: Integer; var Accept: Boolean);
   procedure WatchTreeDragDrop(Sender: TBaseVirtualTree; Source: TObject; DataObject: IDataObject; Formats: TFormatArray; Shift: TShiftState; Pt: TPoint; var Effect: Integer; Mode: TDropMode);
   procedure EvaluateModifyItemClick(Sender: TObject);
   procedure NewWatchItemClick(Sender: TObject);
   procedure WatchTreeGetImageIndex(Sender: TBaseVirtualTree; Node: PVirtualNode; Kind: TVTImageKind; Column: TColumnIndex; var Ghosted: Boolean; var ImageIndex: Integer);
   procedure WatchTreeMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X: Integer; Y: Integer);
   procedure WatchTreeScroll(Sender: TBaseVirtualTree; DeltaX: Integer; DeltaY: Integer);
   procedure WatchTreeCreateEditor(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex; out EditLink: IVTEditLink);
   procedure FormCreate(Sender: TObject);
   ...
   property WatchItemCount: Integer;
   property Action: TBasicAction;
   property ActiveControl: TWinControl;
   property Align: TAlign;
