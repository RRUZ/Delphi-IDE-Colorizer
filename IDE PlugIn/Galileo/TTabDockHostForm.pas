type
  TTabDockHostForm=class(TBaseDockHostForm)
  private
   FActivePage         :TPanel;
   FDockInfos          :TObjectList;
   FDownDockInfo       :TTabDockInfo;
   FDownPos            :TPoint;
   FItemToHide         :Integer;
   FDraggingInfo       :TTabDockInfo;
   FOriginalIndex      :Integer;
   FLastFocusedClient  :TDockableForm;
   FHostDockNumber     :Integer;
   FDontReleaseForm    :Boolean;
  ...
  public
   ...
   function AddIconToImageList(const Client: TControl): Integer;
   function GetClientCaption(const Client: TControl): string;
   procedure LoadWindowState(Desktop: TCustomIniFile);
   procedure ManualDockClient(Client: TControl; DropControl: TControl; ControlSide: TAlign; Replace: Boolean);
   procedure SaveWindowState(Desktop: TCustomIniFile; isProject: Boolean);
   procedure ResetCaption;
   procedure ShowDockClient(const Control: TControl);
   constructor Create(AOwner: TComponent);
   class destructor Destroy;
   procedure ManualDockClient(Client: TControl; DropControl: TControl; ControlSide: TAlign; Replace: Boolean);
   procedure ResetCaption;
   procedure ResetStayOnTop;
   procedure UndockAllClientsAndSelf;
   constructor Create(AOwner: TComponent);
   procedure ForceShow;
   ...
   class destructor Destroy;
   property VisibleClientCount: Integer;
   property HostDockNumber: Integer;
   property DontReleaseForm: Boolean;
  ...
  published
   TabPosPopupMenu     :TPopupActionBar;
   mnuTop              :TMenuItem;
   mnuLeft             :TMenuItem;
   mnuRight            :TMenuItem;
   mnuBottom           :TMenuItem;
   DockPanel           :TPanel;
   DockImageList       :TImageList;
   DockTab             :TTabSet;
   N2                  :TMenuItem;
   mnuHideTab          :TMenuItem;
   ...
   procedure DockTabGetImageIndex(Sender: TObject; TabIndex: Integer; var ImageIndex: Integer);
   procedure DockTabMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X: Integer; Y: Integer);
   procedure DockTabMouseMove(Sender: TObject; Shift: TShiftState; X: Integer; Y: Integer);
   procedure DockTabMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X: Integer; Y: Integer);
   procedure DockTabClick(Sender: TObject);
   procedure mnuHideTabClick(Sender: TObject);
   procedure TabPosPopupMenuPopup(Sender: TObject);
