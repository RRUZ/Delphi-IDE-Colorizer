type
  TDotNetDesignerFrame=class(TViewFrame)
  private
   FInteropFileList    :IInterfaceList;
   FWinControlList     :TList;
   FLastWindow         :TWinControl;
   FNotifierList       :IInterfaceList;
   FActiveDesignerModule:IWinFormDesignerModule;
   FSquelchActivate    :Byte;
  ...
  public
   ...
   procedure Display(const AContext: IInterface);
   procedure FillToolbarMenu(AParent: TMenuItem);
   procedure RemoveInteropFile(const InteropFile: IInteropFile);
   procedure SetFocus;
   constructor Create(AOwner: TComponent);
   class destructor Destroy;
  ...
  published
   ...
   property ActiveDesignerHandle: NativeUInt;
   property Align: TAlign;
   property Anchors: TAnchors;
