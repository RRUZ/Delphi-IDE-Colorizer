type
  TThreadStatus=class(TDockableForm)
  private
   FShouldShowProcessProperties:Boolean;
  ...
  published
   ...
   ProcessPropertiesItem:TMenuItem;
   N2                  :TMenuItem;
   ...
   PauseItem           :TMenuItem;
   N3                  :TMenuItem;
   FreezeItem          :TMenuItem;
   ThawItem            :TMenuItem;
   FreezeAllOtherThreadsItem:TMenuItem;
   ThawAllThreadsItem  :TMenuItem;
   NameThreadItem      :TMenuItem;
   ...
   procedure MakeCurrentClick(Sender: TObject);
   ...
   procedure ProcessPropertiesItemClick(Sender: TObject);
   procedure FormDestroy(Sender: TObject);
   procedure FreezeItemClick(Sender: TObject);
   procedure ThawItemClick(Sender: TObject);
   procedure FreezeAllOtherThreadsItemClick(Sender: TObject);
   procedure ThawAllThreadsItemClick(Sender: TObject);
   procedure NameThreadItemClick(Sender: TObject);
   procedure FormCreate(Sender: TObject);
