type
  TWelcomePageFrame=class(TFrame)
  private
   FDefaultToolbarState:TStream;
   FCurWelcomePageView :TWelcomePageView;
   FCurHistoryItem     :IInterface;
   FNotifierIndex      :Integer;
   FToolbarNotifier    :IOTANotifier;
   FCustomizeDlg       :TComponent;
   FCurWelcomeBrowser  :TWebBrowserEx;
   FWelcomePageViews   :TList;
   FShDocLc            :NativeUInt;
  ...
  public
   ...
   class destructor Destroy;
   property CurWelcomePageView: TWelcomePageView;
  ...
  published
   WelcomeToolbar      :TToolBar;
   URLEntry            :THistoryPropComboBox;
   BackButton          :TToolButton;
   ForwardButton       :TToolButton;
   Separator           :TToolButton;
   StopButton          :TToolButton;
   RefreshButton       :TToolButton;
   WelcomeButton       :TToolButton;
   GoButton            :TToolButton;
   PopupActionBar1     :TPopupActionBar;
   CustomizeItem       :TMenuItem;
   procedure WelcomePageBrowserGetExternalDispatch(Sender: TObject; out ExternalDisp: IDispatch);
   procedure WelcomePageBrowserTitleChange(ASender: TObject; const Text: WideString);
   procedure WelcomePageBrowserBeforeNavigate2(ASender: TObject; const pDisp: IDispatch; const URL: OleVariant; const Flags: OleVariant; const TargetFrameName: OleVariant; const PostData: OleVariant; const Headers: OleVariant; var Cancel: WordBool);
   procedure WelcomePageBrowserNavigateError(ASender: TObject; const pDisp: IDispatch; const URL: OleVariant; const Frame: OleVariant; const StatusCode: OleVariant; var Cancel: WordBool);
   procedure WelcomePageBrowserDocumentComplete(ASender: TObject; const pDisp: IDispatch; const URL: OleVariant);
   procedure WelcomeToolbarResize(Sender: TObject);
   procedure CustomizeItemClick(Sender: TObject);
   procedure WelcomePageBrowserNewWindow2(ASender: TObject; var ppDisp: IDispatch; var Cancel: WordBool);
   procedure WelcomePageGetDropTarget(Sender: TObject; const pDropTarget: IDropTarget; out ppDropTarget: IDropTarget);
   procedure WelcomePageShowContextMenu(Sender: TObject; dwID: Cardinal; ppt: PtagPoint; const pcmdtReserved: IInterface; const pdispReserved: IDispatch; var Result: HRESULT);
   procedure WelcomePageInitMenuPopup(Sender: TObject; Menu: HMENU; Pos: SmallInt; SystemMenu: Boolean);
   procedure WelcomePageOpenNewWindow(Sender: TObject);
   property Align: TAlign;
   property Anchors: TAnchors;
